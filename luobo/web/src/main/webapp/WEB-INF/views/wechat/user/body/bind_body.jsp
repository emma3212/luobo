...
<div class="page">
    <form class="J_validForm" autoComplete="off" action="${website}wechat/user/bind" method="post">
        <input type="hidden" value="${openId}" name="openId" />
        <div>
            <a href="javascript:;" class="logo"></a>

            <h3 class="lighter-black">绑定会员</h3>
            ...
            <button type="submit" class="form-btn-submit middle bigger-font">绑定</button>
    </form>
</div>
