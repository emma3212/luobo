...
<tiles:insertDefinition name="wechat">
    ...
    <tiles:putAttribute name="body" value="/WEB-INF/views/wechat/order/product/body/order_list_body.jsp"/>
    <tiles:putAttribute name="script" value="/WEB-INF/views/wechat/order/product/inc/order_list_script.jsp"/>
