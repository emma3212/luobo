...
<div class="holder">
    <div class="content">
        ...
        <div class="tab tab-horizon tab-red">
            ...
            <form data-fold="fold" class="box box-blue no-margin-box J_addForm" autoComplete="off" action="${website}admin/product/new" method="post">
                <!-- 套返回的错误信息 -->
                        ...
                        <div class="box-container show-parent">
                            <div class="box-body">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="w200 valid-icon" data-valid-tip="1-60个字符，请输入商品名称|商品名称有误，商品名称必须是1到60个字符，请正确填写。" data-valid-rule="length(0,61)" name="name" value="${product.name}" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="w200 valid-icon" data-valid-tip="1-60个字符，请输入商品编码|商品编码有误，商品编码必须是1到60个字符，请正确填写。" data-valid-rule="length(0,61)" name="code" value="${product.code}" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="J_brand" data-valid-tip="|所属品牌有误，请重新选择" data-valid-rule="scale(0,1000)" name="brandId">
                            ...
                            <img src="" onerror="javascript:this.src='${staticWebsite}img/admin/common/default-img.jpg'" class="show-picture J_productPic" alt="产品图片">
                        </div>
                    </div>
                    <div class="tab-content">
                        <div class="box-title clearfix">
