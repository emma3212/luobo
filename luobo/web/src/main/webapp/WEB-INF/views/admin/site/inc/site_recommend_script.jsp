...
<script type="text/template" id="editTpl">
    <tr data-product-id="&{id}" data-type="&{type}">
        ...
        <td>
            <input type="text" class="form-control input-small valid-icon" data-valid-rule="isInteger" name="pid"
                   value="&{pid}"/>
        </td>
        <td>
            <input type="text" class="form-control input-small valid-icon" data-valid-rule="notNull" name="url"
                   value="&{url}"/>
        </td>
        <td>
            <input type="text" class="form-control input-small valid-icon" data-valid-rule="isInteger" name="rank"
                   value="&{rank}"/>
        </td>
        <td>
