...
<script type="text/template" id="editTpl">
    <tr data-repay-id="&{id}">
        <td>&{planPrice}</td>
        <td><input type="text" data-valid-rule="isFloat" class="form-control input-small" name="actualRepayMoney"
                   value="&{actualRepayMoney}"/></td>
        <td>&{lastTime}</td>
        <td><input type="text" class="form-control input-small J_realTime" data-valid-rule="notNull" readonly="readonly"
                   name="actualRepayDate" value="&{actualRepayDate}"/>
        </td>
        <td>
...
<script type="text/javascript">
    KISSY.ready(function (S) {
        S.use('page/order/view', function () {
            PW.page.order.View();
        });
    });
</script>